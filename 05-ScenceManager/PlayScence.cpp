...
void CPlayScene::_ParseSection_OBJECTS(string line)
{
	...
	case OBJECT_TYPE_WHIP: 
		obj = new Whip();
		player->whip = (Whip*)obj; //assuming Simon is created before the whip
		break;
...
void CPlayScene::Update(DWORD dt)
{
	...
	{
		if (objects[i]->isActive) //temporary solution: if object is null then don't update
	...
	if (cx < 0) { cx = 0; }
	if (cx > 768 - SCREEN_WIDTH) { cx = 768 - SCREEN_WIDTH; }
